...
using Dependency_order = jss::strong_typedef<
        struct Dependency_order_tag, std::int32_t, jss::strong_typedef_properties::comparable,
        jss::strong_typedef_properties::hashable, jss::strong_typedef_properties::incrementable,
...
using Typed_component_index =
        jss::strong_typedef<ComponentType, std::size_t, jss::strong_typedef_properties::comparable,
